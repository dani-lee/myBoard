...
import com.myBoard.context.ApplicationContext;

@WebListener
public class ApplicationContextInitListner implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent ctxEvent) {
		...
		try {
			...
			Map<String, Object> applicationContext = ApplicationContext.getApplicationcontext(); // appplication context
